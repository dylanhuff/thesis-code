 ...
 */
   ...
   public PPVariable(String name, double width, double height) {
      ...
      add(border);
      label = new PPTextBox(name);
      label.setFont(LABEL_FONT);
      display = null;
      quoteFlag = false;
      setValueFont(VALUE_FONT);
...
/**
 * Sets the font for the value.  In this version of <code>setValueFont</code>,
 * the font is expressed as a string in the form
 *
 *<pre>
 *    "<i>family</i>-<i>style</i>-<i>size</i>"
 ...
 */
   ...
   public void setQuoteFlag(boolean flag) {
      quoteFlag = flag;
   }
