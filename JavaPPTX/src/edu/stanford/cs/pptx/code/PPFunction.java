...
/**
 * Highlights the specified substring on a particular line.
 *
 * @param str The text that identifies the line
 * @param substring The substring you want to highlight
 */

   public void highlight(String str, String substring) {
      int index = findCodeLine(str);
      String line = code[index];
      int p1 = line.indexOf(substring);
      highlight(index, p1, p1 + substring.length());
   }
