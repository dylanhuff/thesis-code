 ...
 */
   ...
   public PPWindowImage(String title, double width, double height,
      ...
      sw = SF * width;
      sh = SF * height;
      setImage(createWindowImage(showControls));
...
/* Private methods */
   ...
   private Image createWindowImage(boolean showControls) {
      int iw = (int) (sw + 0.99);
      int ih = (int) (sh + 0.99);
   ...
   private void drawTitleBar(Graphics2D g, boolean showControls) {
      Graphics2D g2 = (Graphics2D) g.create();
