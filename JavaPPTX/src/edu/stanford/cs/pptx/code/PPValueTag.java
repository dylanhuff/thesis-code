 ...
 */
   ...
   public PPValueTag(Rectangle2D bb, Object value,
      ...
      lineMarker.setLineWidth(DEFAULT_LINE_WEIGHT);
      ...
      valueOval.setLineWidth(DEFAULT_LINE_WEIGHT);
...
/**
 * Sets the line width for the value tag.
 *
 * @param width The new line width in points
 */

   public void setLineWidth(double width) {
      lineMarker.setLineWidth(width);
      valueOval.setLineWidth(width);
   }
