 ...
 */
   ...
   public PPCodeTraceSlide() {
      ...
      syntaxColorer = new PPSyntaxColorer();
      ...
      setFrameDeltas(DEFAULT_FRAME_DX, DEFAULT_FRAME_DY);
      setMaxStackDepth(1);
   }
 ...
 */
   ...
   public Object call(String name, Object... args) {
      ...
      sf.setSyntaxColorer(syntaxColorer);
 ...
 */
   ...
   public void setFrameDeltas(double dx, double dy) {
      frameDX = dx;
      frameDY = dy;
   }
 ...
 */
   ...
   public void addConsole(String title, double x, double y,
                                        double width, double height) {
      addConsole(title, x, y, width, height, true);
   }

/**
 * Adds a console to this slide with the specified title and bounds.
 * The <code>showControls</code> parameter determines whether the Mac-style
 * controls appear.
 *
 * @param title The title of the console
 * @param x The x coordinate of the left edge of the console
 ...
 * @param width The width of the console
 * @param height The height of the console
 * @param showControls A flag indicating whether the Mac controls appear
 */

   public void addConsole(String title, double x, double y,
                                        double width, double height,
                                        boolean showControls) {
      console = new PPConsole(title, x, y, width, height, showControls);
      add(console);
   }
...
/* Protected methods */
   ...
   protected Rectangle2D getFrameBounds() {
      double x = frameRegion.getX() + stack.size() * frameDX;
      double y = frameRegion.getY() + stack.size() * frameDY;
      double w = frameRegion.getWidth() - (maxDepth - 1) * frameDX;
...
/* Private constants */
   ...
   private static final double DEFAULT_FRAME_DX = 10;
   private static final double DEFAULT_FRAME_DY = 24;
