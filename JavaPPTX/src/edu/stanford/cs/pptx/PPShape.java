...
/**
 * This abstract class represents the top of the hierarchy of shapes
 * that can appear on a PowerPoint slide.
...
/* Protected methods */
   ...
   protected String getFrameTag() {
      if (rotation == 0) {
         return "<a:xfrm>";
      } else {
         return "<a:xfrm rot='" + (int) Math.round(-60000 * rotation) + "'>";
      }
   }
