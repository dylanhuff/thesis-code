/*
 * File: RotateEffect.java
 * -----------------------
 * This class implements the Rotate effect.  This effect is the same as
 * Spin except that the angles are measured in the conventional
 ...
 *     <td>The counterclockwise rotation in degrees</td></tr>
 * </table>
 */

public class RotateEffect extends AnimationEffect {

   public RotateEffect() {
      super("Rotate");
   }

   public RotateEffect(String options) {
      this();
