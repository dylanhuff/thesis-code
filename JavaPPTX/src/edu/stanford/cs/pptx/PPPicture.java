...
/* Private methods */
   ...
   private static Image readDataImage(String url) {
      ...
      byte[] data = decodeBase64(url.substring(p0));
 ...
 * Implementation note
 * -------------------
 * This method makes it possible to decode Base64 strings in older versions
 * of Java (which lack the java.util.base64 package) as well as in newer
 * version (in which javax.xml.bind.DatatypeConverter is deprecated).
 */

   private static byte[] decodeBase64(String str) {
      try {
         Class<?> base64Class = Class.forName("java.util.Base64");
         Method fn = base64Class.getMethod("getDecoder", new Class<?>[0]);
         Object decoder = fn.invoke(null, new Object[0]);
         Class<?> decoderClass = decoder.getClass();
         Class<?>[] types = { Class.forName("java.lang.String") };
         Object[] args = { str };
         fn = decoderClass.getMethod("decode", types);
         return (byte[]) fn.invoke(decoder, args);
      } catch (Exception ex) {
         /* Empty */
      }
      try {
         ...
         Class<?>[] types = { Class.forName("java.lang.String") };
         Object[] args = { str };
         Method fn = converterClass.getMethod("parseBase64Binary", types);
         return (byte[]) fn.invoke(null, args);
      } catch (Exception ex) {
