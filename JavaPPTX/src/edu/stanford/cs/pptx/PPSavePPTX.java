...
import edu.stanford.cs.pptx.util.HexByteInputStream;
...
/* Private methods */
   ...
   private void dumpSlideMasters(PPOutputStream os) throws IOException {
      os.putNextEntry(new ZipEntry("ppt/slideMasters/slideMaster1.xml"));
      os.println("<?xml version='1.0' encoding='UTF-8' standalone='yes'?>");
      os.print("<p:sldMaster " +
               ...
               "mc:Ignorable='mv' mc:PreserveAttributes='mv:*' " +
      ...
      os.print(PPUtil.getColorTag(show.getBackground()));
      os.print("</a:solidFill>");
      ...
      os.print("<p:sp>");
      os.print("<p:nvSpPr>");
      os.print("<p:cNvPr id='1026' name='Rectangle 2'/>");
      os.print("<p:cNvSpPr>");
      ...
      os.print("<a:xfrm>");
      os.print("<a:off x='685800' y='609600'/>");
      os.print("<a:ext cx='7772400' cy='1143000'/>");
      os.print("</a:xfrm>");
      os.print("<a:prstGeom prst='rect'>");
      os.print("<a:avLst/>");
      os.print("</a:prstGeom>");
      os.print("<a:noFill/>");
      os.print("<a:ln w='9525'>");
      os.print("<a:noFill/>");
      os.print("<a:miter lim='800000'/>");
      os.print("<a:headEnd/>");
      os.print("<a:tailEnd/>");
      os.print("</a:ln>");
      os.print("</p:spPr>");
      os.print("<p:txBody>");
      os.print("<a:bodyPr vert='horz' wrap='square' lIns='91440' " +
               "tIns='45720' rIns='91440' bIns='45720' numCol='1' " +
               "anchor='ctr' anchorCtr='0' compatLnSpc='1'>");
      ...
      os.print("<a:lstStyle/>");
      os.print("<a:p>");
      os.print("<a:pPr lvl='0'/>");
      os.print("<a:r>");
      os.print("<a:rPr lang='en-US'/>");
      os.print("<a:t>Click to edit Master title style</a:t>");
      os.print("</a:r>");
      os.print("</a:p>");
      os.print("</p:txBody>");
      os.print("</p:sp>");
      os.print("<p:sp>");
      os.print("<p:nvSpPr>");
      os.print("<p:cNvPr id='1027' name='Rectangle 3'/>");
      os.print("<p:cNvSpPr>");
      os.print("<a:spLocks noGrp='1' noChangeArrowheads='1'/>");
      os.print("</p:cNvSpPr>");
      os.print("<p:nvPr>");
      os.print("<p:ph type='body' idx='1'/>");
      os.print("</p:nvPr>");
      os.print("</p:nvSpPr>");
      os.print("<p:spPr bwMode='auto'>");
      os.print("<a:xfrm>");
      os.print("<a:off x='685800' y='1981200'/>");
      os.print("<a:ext cx='7772400' cy='4114800'/>");
      os.print("</a:xfrm>");
      os.print("<a:prstGeom prst='rect'>");
      os.print("<a:avLst/>");
      os.print("</a:prstGeom>");
      ...
      os.print("<a:bodyPr vert='horz' wrap='square' lIns='91440' " +
               "tIns='45720' rIns='91440' bIns='45720' numCol='1' " +
               "anchor='t' anchorCtr='0' compatLnSpc='1'>");
      os.print("<a:prstTxWarp prst='textNoShape'>");
      os.print("<a:avLst/>");
      os.print("</a:prstTxWarp>");
      os.print("</a:bodyPr>");
      ...
      os.print("<a:r>");
      os.print("<a:rPr lang='en-US'/>");
      os.print("<a:t>Click to edit Master text styles</a:t>");
      os.print("</a:r>");
      os.print("</a:p>");
      os.print("<a:p>");
      os.print("<a:pPr lvl='1'/>");
      os.print("<a:r>");
      os.print("<a:rPr lang='en-US'/>");
      os.print("<a:t>Second level</a:t>");
      os.print("</a:r>");
      os.print("</a:p>");
      os.print("<a:p>");
      os.print("<a:pPr lvl='2'/>");
      os.print("<a:r>");
      os.print("<a:rPr lang='en-US'/>");
      os.print("<a:t>Third level</a:t>");
      os.print("</a:r>");
      os.print("</a:p>");
      os.print("<a:p>");
      os.print("<a:pPr lvl='3'/>");
      os.print("<a:r>");
      os.print("<a:rPr lang='en-US'/>");
      os.print("<a:t>Fourth level</a:t>");
      os.print("</a:r>");
      os.print("</a:p>");
      os.print("<a:p>");
      os.print("<a:pPr lvl='4'/>");
      os.print("<a:r>");
      os.print("<a:rPr lang='en-US'/>");
      os.print("<a:t>Fifth level</a:t>");
      os.print("</a:r>");
      os.print("</a:p>");
      os.print("</p:txBody>");
      os.print("</p:sp>");
      os.print("<p:sp>");
      os.print("<p:nvSpPr>");
      os.print("<p:cNvPr id='1028' name='Rectangle 4'/>");
      os.print("<p:cNvSpPr>");
      os.print("<a:spLocks noGrp='1' noChangeArrowheads='1'/>");
      os.print("</p:cNvSpPr>");
      os.print("<p:nvPr>");
      os.print("<p:ph type='dt' sz='half' idx='2'/>");
      os.print("</p:nvPr>");
      os.print("</p:nvSpPr>");
      os.print("<p:spPr bwMode='auto'>");
      os.print("<a:xfrm>");
      os.print("<a:off x='685800' y='6248400'/>");
      os.print("<a:ext cx='1905000' cy='457200'/>");
      os.print("</a:xfrm>");
      os.print("<a:prstGeom prst='rect'>");
      os.print("<a:avLst/>");
      os.print("</a:prstGeom>");
      ...
      os.print("<a:lvl1pPr>");
      os.print("<a:defRPr>");
      os.print("<a:latin typeface='Times New Roman' pitchFamily='1' " +
               "charset='0'/>");
      os.print("</a:defRPr>");
      os.print("</a:lvl1pPr>");
      os.print("</a:lstStyle>");
      os.print("<a:p>");
      os.print("<a:endParaRPr lang='en-US'/>");
      os.print("</a:p>");
      os.print("</p:txBody>");
      os.print("</p:sp>");
      os.print("<p:sp>");
      os.print("<p:nvSpPr>");
      os.print("<p:cNvPr id='1029' name='Rectangle 5'/>");
      os.print("<p:cNvSpPr>");
      os.print("<a:spLocks noGrp='1' noChangeArrowheads='1'/>");
      os.print("</p:cNvSpPr>");
      os.print("<p:nvPr>");
      os.print("<p:ph type='ftr' sz='quarter' idx='3'/>");
      os.print("</p:nvPr>");
      os.print("</p:nvSpPr>");
      os.print("<p:spPr bwMode='auto'>");
      os.print("<a:xfrm>");
      os.print("<a:off x='3124200' y='6248400'/>");
      os.print("<a:ext cx='2895600' cy='457200'/>");
      os.print("</a:xfrm>");
      os.print("<a:prstGeom prst='rect'>");
      os.print("<a:avLst/>");
      os.print("</a:prstGeom>");
      ...
      os.print("<p:sp>");
      os.print("<p:nvSpPr>");
      os.print("<p:cNvPr id='1030' name='Rectangle 6'/>");
      os.print("<p:cNvSpPr>");
      os.print("<a:spLocks noGrp='1' noChangeArrowheads='1'/>");
      os.print("</p:cNvSpPr>");
      os.print("<p:nvPr>");
      os.print("<p:ph type='sldNum' sz='quarter' idx='4'/>");
      os.print("</p:nvPr>");
      os.print("</p:nvSpPr>");
      os.print("<p:spPr bwMode='auto'>");
      os.print("<a:xfrm>");
      os.print("<a:off x='6553200' y='6248400'/>");
      os.print("<a:ext cx='1905000' cy='457200'/>");
      os.print("</a:xfrm>");
      os.print("<a:prstGeom prst='rect'>");
      os.print("<a:avLst/>");
      ...
      os.print("</a:lstStyle>");
      os.print("<a:p>");
      os.print("<a:fld id='{7845CED8-D252-A943-B5BA-BDE9EB98CAA0}' " +
               "type='slidenum'>");
      os.print("<a:rPr lang='en-US'/>");
      os.print("<a:pPr/>");
      os.print("<a:t>\u2039#\u203A</a:t>");
      ...
      os.print("</p:spTree>");
      os.print("</p:cSld>");
      os.print("<p:clrMap bg1='lt1' tx1='dk1' bg2='lt2' tx2='dk2' " +
               "accent1='accent1' accent2='accent2' accent3='accent3' " +
               "accent4='accent4' accent5='accent5' accent6='accent6' " +
               "hlink='hlink' folHlink='folHlink'/>");
      os.print("<p:sldLayoutIdLst>");
      os.print("<p:sldLayoutId id='2147483649' r:id='rId1'/>");
      os.print("<p:sldLayoutId id='2147483650' r:id='rId2'/>");
      os.print("<p:sldLayoutId id='2147483651' r:id='rId3'/>");
      os.print("<p:sldLayoutId id='2147483652' r:id='rId4'/>");
      os.print("<p:sldLayoutId id='2147483653' r:id='rId5'/>");
      os.print("<p:sldLayoutId id='2147483654' r:id='rId6'/>");
      os.print("<p:sldLayoutId id='2147483655' r:id='rId7'/>");
      os.print("<p:sldLayoutId id='2147483656' r:id='rId8'/>");
      os.print("<p:sldLayoutId id='2147483657' r:id='rId9'/>");
      os.print("<p:sldLayoutId id='2147483658' r:id='rId10'/>");
      os.print("<p:sldLayoutId id='2147483659' r:id='rId11'/>");
      os.print("</p:sldLayoutIdLst>");
      os.print("<p:txStyles>");
      os.print("<p:titleStyle>");
      os.print("<a:lvl1pPr algn='ctr' rtl='0' eaLnBrk='0' " +
      ...
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcAft>");
      os.print("<a:defRPr sz='4400'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx2'/>");
      os.print("</a:solidFill>");
      os.print("<a:latin typeface='Times New Roman' pitchFamily='1' " +
               "charset='0'/>");
      os.print("<a:ea typeface='+mj-ea'/>");
      os.print("<a:cs typeface='+mj-cs'/>");
      os.print("</a:defRPr>");
      os.print("</a:lvl1pPr>");
      os.print("<a:lvl2pPr algn='ctr' rtl='0' eaLnBrk='0' " +
               "fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl2pPr>");
      os.print("<a:lvl3pPr algn='ctr' rtl='0' eaLnBrk='0' " +
               "fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl3pPr>");
      os.print("<a:lvl4pPr algn='ctr' rtl='0' eaLnBrk='0' " +
               "fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl4pPr>");
      os.print("<a:lvl5pPr algn='ctr' rtl='0' eaLnBrk='0' " +
               "fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl5pPr>");
      os.print("<a:lvl6pPr marL='457200' algn='ctr' rtl='0' eaLnBrk='0' " +
               "fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcBef>");
      ...
      os.print("<a:schemeClr val='tx2'/>");
      os.print("</a:solidFill>");
      os.print("<a:latin typeface='Times' pitchFamily='84' charset='0'/>");
      os.print("</a:defRPr>");
      os.print("</a:lvl6pPr>");
      os.print("<a:lvl7pPr marL='914400' algn='ctr' rtl='0' eaLnBrk='0' " +
               "fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl7pPr>");
      os.print("<a:lvl8pPr marL='1371600' algn='ctr' rtl='0' eaLnBrk='0' " +
               "fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl8pPr>");
      os.print("<a:lvl9pPr marL='1828800' algn='ctr' rtl='0' eaLnBrk='0' " +
               "fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:lvl9pPr>");
      os.print("</p:titleStyle>");
      os.print("<p:bodyStyle>");
      os.print("<a:lvl1pPr marL='342900' indent='-342900' algn='l' rtl='0' " +
               "eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      os.print("<a:spcAft>");
      os.print("<a:spcPct val='0'/>");
      os.print("</a:spcAft>");
      os.print("<a:buChar char='\u2022'/>");
      os.print("<a:defRPr sz='3200'>");
      os.print("<a:solidFill>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl1pPr>");
      os.print("<a:lvl2pPr marL='742950' indent='-285750' algn='l' rtl='0' " +
               "eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:spcAft>");
      os.print("<a:buChar char='\u2013'/>");
      os.print("<a:defRPr sz='2800'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
      os.print("</a:solidFill>");
      os.print("<a:latin typeface='Times New Roman' pitchFamily='1' " +
               "charset='0'/>");
      os.print("<a:ea typeface='\uFF2D\uFF33 " +
               "\uFF30\u30B4\u30B7\u30C3\u30AF' pitchFamily='1' " +
               "charset='-128'/>");
      os.print("</a:defRPr>");
      os.print("</a:lvl2pPr>");
      os.print("<a:lvl3pPr marL='1143000' indent='-228600' algn='l' " +
               "rtl='0' eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      os.print("<a:spcAft>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl3pPr>");
      os.print("<a:lvl4pPr marL='1600200' indent='-228600' algn='l' " +
               "rtl='0' eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl4pPr>");
      os.print("<a:lvl5pPr marL='2057400' indent='-228600' algn='l' " +
               "rtl='0' eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl5pPr>");
      os.print("<a:lvl6pPr marL='2514600' indent='-228600' algn='l' " +
               "rtl='0' eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      ...
      os.print("<a:schemeClr val='tx1'/>");
      os.print("</a:solidFill>");
      os.print("<a:latin typeface='+mn-lt'/>");
      os.print("</a:defRPr>");
      os.print("</a:lvl6pPr>");
      os.print("<a:lvl7pPr marL='2971800' indent='-228600' algn='l' " +
               "rtl='0' eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl7pPr>");
      os.print("<a:lvl8pPr marL='3429000' indent='-228600' algn='l' rtl='0' " +
               "eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl8pPr>");
      os.print("<a:lvl9pPr marL='3886200' indent='-228600' algn='l' rtl='0' " +
               "eaLnBrk='0' fontAlgn='base' hangingPunct='0'>");
      os.print("<a:spcBef>");
      os.print("<a:spcPct val='20000'/>");
      os.print("</a:spcBef>");
      ...
      os.print("</a:lvl9pPr>");
      os.print("</p:bodyStyle>");
      os.print("<p:otherStyle>");
      os.print("<a:defPPr>");
      os.print("<a:defRPr lang='en-US'/>");
      os.print("</a:defPPr>");
      os.print("<a:lvl1pPr marL='0' algn='l' defTabSz='914400' rtl='0' " +
               "eaLnBrk='1' latinLnBrk='0' hangingPunct='1'>");
      os.print("<a:defRPr sz='1800' kern='1200'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
      os.print("</a:solidFill>");
      os.print("<a:latin typeface='+mn-lt'/>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl1pPr>");
      os.print("<a:lvl2pPr marL='457200' algn='l' defTabSz='914400' rtl='0' " +
               "eaLnBrk='1' latinLnBrk='0' hangingPunct='1'>");
      os.print("<a:defRPr sz='1800' kern='1200'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl2pPr>");
      os.print("<a:lvl3pPr marL='914400' algn='l' defTabSz='914400' rtl='0' " +
               "eaLnBrk='1' latinLnBrk='0' hangingPunct='1'>");
      os.print("<a:defRPr sz='1800' kern='1200'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl3pPr>");
      os.print("<a:lvl4pPr marL='1371600' algn='l' defTabSz='914400' " +
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl4pPr>");
      os.print("<a:lvl5pPr marL='1828800' algn='l' defTabSz='914400' " +
               "rtl='0' eaLnBrk='1' latinLnBrk='0' hangingPunct='1'>");
      os.print("<a:defRPr sz='1800' kern='1200'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl5pPr>");
      os.print("<a:lvl6pPr marL='2286000' algn='l' defTabSz='914400' " +
               "rtl='0' eaLnBrk='1' latinLnBrk='0' hangingPunct='1'>");
      os.print("<a:defRPr sz='1800' kern='1200'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl6pPr>");
      os.print("<a:lvl7pPr marL='2743200' algn='l' defTabSz='914400' " +
               "rtl='0' eaLnBrk='1' latinLnBrk='0' hangingPunct='1'>");
      os.print("<a:defRPr sz='1800' kern='1200'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl7pPr>");
      os.print("<a:lvl8pPr marL='3200400' algn='l' defTabSz='914400' " +
               "rtl='0' eaLnBrk='1' latinLnBrk='0' hangingPunct='1'>");
      os.print("<a:defRPr sz='1800' kern='1200'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
      ...
      os.print("</a:defRPr>");
      os.print("</a:lvl8pPr>");
      os.print("<a:lvl9pPr marL='3657600' algn='l' defTabSz='914400' " +
               "rtl='0' eaLnBrk='1' latinLnBrk='0' hangingPunct='1'>");
      os.print("<a:defRPr sz='1800' kern='1200'>");
      os.print("<a:solidFill>");
      os.print("<a:schemeClr val='tx1'/>");
