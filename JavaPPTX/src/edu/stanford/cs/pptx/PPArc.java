 ...
 * File: PPArc.java
 * ----------------
 * This class represents an elliptical arc.
 */
...
public class PPArc extends PPAutoShape {

/**
 * Creates a new <code>PPArc</code> shape with the specified coordinates,
 ...
 * @param sweep The number of degrees covered by the arc
 */

   public PPArc(double x, double y, double width, double height,
...
/**
 * Creates a new <code>PPArc</code> shape from the specified
 * coordinates and size.  This version of the constructor operates in
 * much the same manner as the standard
 * {@link #PPArc(double,double,double,double,double,double) PPArc}
...
/**
 * Creates a new <code>PPArc</code> shape from its dimensions and angles.
 ...
 */
   ...
   public PPArc(double width, double height, double start, double sweep) {
      this(0, 0, width, height, start, sweep);
   }

/**
 * Creates a new <code>PPArc</code> shape from its dimensions, angles, and
 * an options string.
 *
 * @param width The width of the oval
 * @param height The height of the oval
...
/**
 * Returns the sweep angle for this shape.
 *
 * @return The sweep angle for this shape
 */
...
/**
 * Returns the start angle for this shape.
 *
 * @return The start angle for this shape
 */
