 ...
 * -----------------------
 * This class creates a simple options parser. This version is copied from
 * the edu.stanford.cs.options package to reduce external dependencies.
 */
 ...
 * option specifications, each of which takes one of the following forms:
 *
 * <ol>
 * <li>/key
 * <li>/key:value
