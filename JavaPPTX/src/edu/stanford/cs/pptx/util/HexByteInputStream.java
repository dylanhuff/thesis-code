 ...
 * -----------------------------
 * This file exports a class for reading binary data from a source of ASCII
 * hex bytes.  This version is copied from the edu.stanford.cs.hexbyte
 * package to reduce external dependencies.
 */
