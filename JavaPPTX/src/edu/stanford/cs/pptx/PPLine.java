...
/* Protected methods */
   ...
   protected void dumpShape(PPOutputStream os) {
      ...
      String tag = getFrameTag();
      tag = tag.substring(0, tag.length() - 1);
      switch (quadrant) {
       case 1: os.print(tag + " flipV='1'>"); break;
       case 2: os.print(tag + " flipH='1' flipV='1'>"); break;
       case 3: os.print(tag + " flipH='1'>"); break;
       case 4: os.print(tag + ">"); break;
      }
