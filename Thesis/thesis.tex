...
\end{itemize}
Take Figure 1.1 as an example. The algorithm animation is showing what happens to an AVL tree when the number 2 is inserted into it. The animation currently shows the path the program takes to find the appropriate location to insert 2. 
\begin{figure}[h!tbp] 
\begin{centering} 
...
\end{centering} 
\end{figure}
Figure 1.2 shows what the AVL tree looks like after the animation is completed and 2 has been added. 
\begin{figure}[h!tbp] 
\begin{centering} 
...
In the following sections, I outline the various problems facing CS Higher Education today. These are not the first time these problems have been faced. Rather, this current crisis could be seen as the third boom that has happened.\footnote{\cite{roberts_history}} In the past two booms, there was subsequent decrease in the number of students gradutating with CS. There is no single factor that can account for the historical decreases in the past.\footnote{\cite{committee_on_the_growth_of_computer_science_undergraduate_enrollments_assessing_2018}}   Figure 2.1 shows one boom and bust that occurred in the 1980s. 
...
\fbox{\includegraphics[scale=0.7]{insbefore}}
\label{subd}
\end{centering} 
\end{figure}
...
\fbox{\includegraphics[scale=0.7]{insafter}}
\label{subd}
\end{centering} 
\end{figure}
